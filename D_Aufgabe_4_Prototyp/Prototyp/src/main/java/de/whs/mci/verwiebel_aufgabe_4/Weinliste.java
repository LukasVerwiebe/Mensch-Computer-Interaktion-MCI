 ...
 * @author Lukas
 */
public class Weinliste {
    
    private static final String FXML_FILE = "weinliste.fxml";

    //private final String title;
    private final Stage stage = new Stage();
    
    private static final String TITLE = "Wein-Liste";
    private static final String ICON = "index.png";
    private static final String FXMLDatei = "weinliste.fxml";
    ...
    public void starteWeinliste() throws IOException {
